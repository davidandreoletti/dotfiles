...
[ -d "$HOMEBREW_GNUCOREUTILS_DIR/gnubin" ] && export PATH="$HOMEBREW_GNUCOREUTILS_DIR/gnubin:$PATH"
[ -d "$HOMEBREW_GNUCOREUTILS_DIR/gnuman" ] && export MANPATH="$HOMEBREW_GNUCOREUTILS_DIR/gnuman:$MANPATH"
