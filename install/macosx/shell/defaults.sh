...
# Set the icon size of Dock items to xx pixels
...
# Set screensaver to Word of the Day.qtz
defaults write com.apple.screensaver modulePath -string /System/Library/Screen\ Savers/Word\ of\ the\ Day.qtz
###############################################################################
# Screenshot #
###############################################################################
...
defaults write com.apple.screencapture com.apple.Grab "PNG"
...
# Give time to mds to respond to changes
sleep 5s
...
#ca#open "${HOME}/init/Solarized Dark.itermcolors"
...
# Show advanced image format
defaults write com.apple.DiskUtility advanced-image-options -bool true
# Expert mode
defaults write com.apple.DiskUtility expert-mode -bool true
...
###############################################################################
# Hide splash screen
defaults write com.skype.skype SKShowSplash -bool NO
###############################################################################
# MacVim.app #
###############################################################################
...
if test -f "$USER/Library/Preferences/nsmb.conf"; then
    # Move original file
    mv $USER/Library/Preferences/nsmb.conf{,.original}
